  ...
  useEffect(() => {
    ...
    const process = async () => {
      ...
      const publicClient = createPublicClient({
        transport: http("https://zksync-sepolia.g.alchemy.com/v2/Aqn4xWVZIe3992B7DHpY45WuvQ_Y5S4f"),
        ...
        {currentScreen === Screen.STAKE && (
          <div className="text-center w-full max-w-md p-4">
            ...
            <div className="mb-4 bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded-full w-full text-lg tracking-wider">
              <IDKitWidget
                app_id="app_staging_bbca94d8437a086b0a6ea7038e6d0152" // obtained from the Developer Portal
                action="farm" // this is your action name from the Developer Portal
                signal={address}
